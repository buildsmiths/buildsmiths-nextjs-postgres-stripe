...
npm run db:seed    # Optional: Adds test users`}
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <Card className="h-full">
                    ...
                    <CardContent className="space-y-4">
                        <p className="text-sm text-muted-foreground">
                            Once running, use the included doctor script to check your local environment health:
                        </p>
                        <div className="bg-muted p-2 rounded-md font-mono text-xs text-center border">
                            npm run doctor
                        </div>
                        <p className="text-sm text-muted-foreground pt-2">
                            Then, enable optional features like Stripe or configure your AI providers.
                        </p>
                    </CardContent>
                </Card>
            </div>

...
export const metadata = {
    title: 'Quickstart Subscription Template',
    description: 'Rapid SaaS starter with Next.js, Postgres, Stripe.'
};
                ...
                <Providers>
                    ...
                    <header className="border-b bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
                        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
                            <Link href="/" className="font-semibold text-sm">Quickstart SaaS</Link>
                    ...
                    <footer className="text-xs text-gray-500 py-6 text-center border-t">
                        &copy; {new Date().getFullYear()} Quickstart Template
                    </footer>
                </Providers>
            </body>
        </html>

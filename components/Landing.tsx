        ...
        <div className="mx-auto max-w-5xl px-4 py-16 space-y-16">
            ...
            <section className="space-y-5 text-center">
                ...
                <div className="flex flex-wrap items-center justify-center gap-3">
                    ...
                    <a href="https://github.com/buildsmiths/buildsmiths-nextjs-postgres-stripe" target="_blank" rel="noreferrer" className="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-400">
                        View on GitHub
                    </a>
                </div>
            </section>
